...
public final class StartupManager {
	...
	/**
 	* <span class="en-US">Base path for launcher execute</span>
 	* <span class="en-US">启动器执行的基本目录</span>
	 */
	...
	/**
	 * <h3 class="en-US">Load launcher instance and execute startup method</h3>

...
/**
 * <h2 class="en">Abstract secure adapter class</h2>
 * <h2 class="zh-CN">安全适配器的抽象类</h2>
 *
 * @author Steven Wee	<a href="mailto:wmkm0113@Hotmail.com">wmkm0113@Hotmail.com</a>
 * @version $Revision : 1.0 $ $Date: Jan 13, 2012 11:23:38 $
 */
public abstract class SecureAdapter {
    /**
	 * <h3 class="en">Append given string to current adapter</h3>
	 * <h3 class="zh-CN">追加给定的字符串到当前适配器</h3>
     *
     * @param strIn     <span class="en">Input string</span>
    ...
    /**
	 * <h3 class="en">Append given binary data array to current adapter</h3>
    ...
    /**
	 * <h3 class="en">Append given byte buffer data to current adapter</h3>
	 * <h3 class="zh-CN">追加给定的二进制缓冲器中的数据到当前适配器</h3>
     *
     * @param inBuffer      <span class="en">byte buffer instance</span>
    ...
    /**
	 * <h3 class="en">Calculate final result</h3>
    ...
    /**
	 * <h3 class="en">Append given string to current adapter and calculate final result</h3>
    ...
    /**
	 * <h3 class="en">Append given binary data array to current adapter and calculate final result</h3>
    ...
    /**
	 * <h3 class="en">Append given byte buffer data to current adapter and calculate final result</h3>

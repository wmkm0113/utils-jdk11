...
/**
 * <h2 class="en">Mail configure builder</h2>
 * <h2 class="zh-CN">电子邮件配置信息构造器</h2>
 *
 * @author Steven Wee	<a href="mailto:wmkm0113@Hotmail.com">wmkm0113@Hotmail.com</a>
 * @version $Revision : 1.0 $ $Date: Jul 31, 2022 16:52:27 $
 */
public final class MailConfigBuilder extends AbstractMailConfigBuilder<MailConfig> {
    /**
     * <h3 class="en">Private constructor for MailConfigBuilder</h3>
	...
	/**
     * <h3 class="en">Static method for create MailConfigBuilder instance by new mail configure</h3>
     * <h3 class="zh-CN">私有方法用于使用新的邮件配置信息创建邮件配置构造器实例对象</h3>
	 *
	 * @return	<span class="en">Generated MailConfigBuilder instance</span>
	...
	/**
     * <h3 class="en">Static method for create MailConfigBuilder instance by given mail configure</h3>

...
/**
 * <h2 class="en-US">DataConverter interface class</h2>
...
public interface Adapter<ValueType, BoundType> {
    /**
     * <h3 class="en-US">Encode object to target type</h3>
     * <h3 class="zh-CN">将对象编码为指定类型</h3>
     *
     * @param object    <span class="en-US">Target object instance</span>
     *                  <span class="zh-CN">目标对象实例</span>
     *
     * @return          <span class="en-US">Encoded object instance or null if target object instance is null</span>
     *                  <span class="zh-CN">转换后的对象，如果目标对象实例为空，则返回null</span>
     * @throws Exception
     * <span class="en-US">If an error occurs when execute</span>
     * <span class="zh-CN">当执行时出现错误</span>
     */
    BoundType unmarshal(final ValueType object) throws Exception;
    /**
     * <h3 class="en-US">Decode target instance to object</h3>
     * <h3 class="zh-CN">将给定的对象解码为对象</h3>
     *
     * @param object    <span class="en-US">Source object instance</span>
     *                  <span class="zh-CN">源对象实例</span>
     *
     * @return          <span class="en-US">Decode object instance</span>

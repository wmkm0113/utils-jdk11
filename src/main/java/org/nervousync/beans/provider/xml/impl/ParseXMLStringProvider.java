 ...
 */
public final class ParseXMLStringProvider implements ConvertProvider {

	public ParseXMLStringProvider() {
	}
	...
	public <T> T convert(Object origObj, Class<T> targetClass) {
		if ((origObj instanceof String) && targetClass != null
				&& BaseElement.class.isAssignableFrom(targetClass)) {
			return BaseElement.parseXml((String)origObj, targetClass);
		}
		return null;
	}
}

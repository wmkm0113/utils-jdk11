...
/**
 * <h2 class="en">Parsed request attributes from HttpServletRequest</h2>
...
public final class RequestAttribute {
	/**
	 * <span class="en">Session ID of current request</span>
	 * <span class="zh-CN">当前请求的会话ID</span>
	 */
	private final String sessionId;
	/**
	 * <span class="en">Attributes map of current request</span>
	 * <span class="zh-CN">当前请求包含的属性映射</span>
	 */
	private final Map<String, Object> attributeMap;

	/**
	 * <h3 class="en">Constructor for RequestAttribute</h3>
	 * <p class="en">
	 ...
	 *
	 * @param request	<span class="en">HttpServletRequest instance, must not be null</span>
	 *                  <span class="en">HttpServletRequest实例对象，不允许为null</span>
	 */
	...
	/**
	 * <h3 class="en">Getter method for Session ID</h3>
	...
	/**
	 * <h3 class="en">Getter method for attribute map</h3>

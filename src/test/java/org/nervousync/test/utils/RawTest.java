...
public class RawTest extends BaseTest {
    ...
    @Test
    @Order(101)
    public void testBooleanPosition() {
    ...
    @Test
    @Order(144)
    public void testStringEncodingPosition() {
        String randomString = "中文测试中文测试";
